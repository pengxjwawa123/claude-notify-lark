...
LOOKUP_URL = "https://open.larksuite.com/open-apis/contact/v3/users/batch_get_id?user_id_type=open_id"
...
def main() -> int:
    ...
    try:
        ...
        msg_resp = _api_post(
            f"https://open.larksuite.com/open-apis/im/v1/messages?receive_id_type=open_id",
